        ...
        if jwt_token
            ...
            begin
                ...
                if current_user.role == "user"
                    if user_already_submitted?(current_user[:id])
                        render json: { error: "#{current_user.name} have already submitted answers. Cannot submit again." }, status: :unprocessable_entity
                        return
                    end
